...
/**
 * @brief This is a filter that removes points in a laser scan inside of a
 * cartesian box.
 */
class Box {
public:
...
public:
    MarkerPublisher() {
        ros::NodeHandle nh_("~");
        pub_marker_ =
            nh_.advertise<visualization_msgs::MarkerArray>("multi_box_marker", 1);
    }
